                ...
                <nav className="mt-4 w-full">
                    <ul className="space-y-2 flex flex-col items-center">
                        <li className="w-4/5 hover:bg-blue-500 transition-all rounded-sm group">
                            <Link to="/dashboard" className="w-full text-center h-full p-2 block font-bold group-hover:text-white transition-all">Haz iniciado sesion correctamente</Link>
                        </li>
                    </ul>
                </nav>
